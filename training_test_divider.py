	...
	with open("CASIA.txt", "wb") as txt:
		for i in range(holdouts):
			...
			for j in range(0, n_classes):
				...
				treino_arr = random.sample(files[temp_arr_rows], int(math.ceil(len(files[temp_arr_rows])/3.0)))  # training sample = 33% de fotos 
